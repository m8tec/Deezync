...
def tagID3(path, track, save):
    ...
    if track.album.barcode and save['barcode']:
    ...
    if (save['savePlaylistAsCompilation'] and track.playlist or
            (track.album.recordType and track.album.recordType == "compile")):
        tag.add(TCMP(text="1"))
